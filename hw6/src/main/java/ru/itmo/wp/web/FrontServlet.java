...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        invokeMethod(before, page, view, pageClass, request, response);
        invokeMethod(method, page, view, pageClass,  request, response);
        invokeMethod(after, page, view, pageClass, request, response);
    ...
    private void invokeMethod(Method method, Object page,
                              Map<String, Object> view, Class<?> pageClass,
