...
public class FreemarkerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            template = freemarkerConfiguration.getTemplate(URLDecoder.decode(request.getContextPath(), UTF_8) + "/404.ftlh");
        }
    ...
    private Map<String, Object> getData(HttpServletRequest request) {
        ...
        data.put("currentPage", uri2pageName.get(request.getRequestURI()));
        DataUtil.addData(request, data);
        return data;
    }

    private static final Map<String, String> uri2pageName = new HashMap<>();
    static {
        uri2pageName.put("/index", "Home");
        uri2pageName.put("/misc/help", "Help");
        uri2pageName.put("/contests", "Contests");
        uri2pageName.put("/users", "Users");
    }
}
